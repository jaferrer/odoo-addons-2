...
class TestTemplateTasksPlanningImproved(common.TransactionCase):
    def setUp(self):
        ...
        self.template_task6 = self.browse_ref('project_template_tasks.project_task_10')
        self.template_task7 = self.browse_ref('project_template_tasks.project_task_11')
        self.template_task8 = self.browse_ref('project_template_tasks.project_task_10')
        self.template_task9 = self.browse_ref('project_template_tasks.project_task_11')
    ...
    def test_10_template_tasks_planning_improved(self):
        ...
        self.assertEqual(task6.next_task_ids, task6)
        ...
        self.assertIn(task8, task8.next_task_ids)
        self.assertIn(task9, task8.next_task_ids)
        self.assertFalse(task9.previous_task_ids)
        self.assertEqual(len(task9.next_task_ids), 2)
        self.assertIn(task8, task9.next_task_ids)
        self.assertIn(task9, task9.next_task_ids)
