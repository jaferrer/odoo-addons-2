...
class SaleOrderProjectImproved(models.Model):
    ...
    def _onchange_project_id(self):
        ...
        if self.project_id:
            ...
            self.partner_shipping_id = self.project_id.partner_delivery_id.id
            self.activity_id = self.project_id.activity_id.id
            self.activity_domain_id = self.project_id.activity_domain_id.id
