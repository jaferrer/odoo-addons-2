...
class TimesheetHolidayTest(TestHrHolidaysBase):
    def setUp(self):
        ...
        self.holiday_status_sl = self.env.ref('hr_holidays.holiday_status_sl')
    ...
    def test_all(self):
        ...
        leave = hol_empl_grp.create({
            ...
            'holiday_status_id': self.holiday_status_sl.id,
