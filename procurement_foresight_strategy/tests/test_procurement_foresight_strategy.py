...
class TestProcurementForesightStrategy(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.out_move_1.date = (datetime.now()+timedelta(4)).strftime(DEFAULT_SERVER_DATETIME_FORMAT)
        self.out_move_2.date = (datetime.now()+timedelta(6)).strftime(DEFAULT_SERVER_DATETIME_FORMAT)
        self.out_move_3.date = (datetime.now()+timedelta(8)).strftime(DEFAULT_SERVER_DATETIME_FORMAT)
