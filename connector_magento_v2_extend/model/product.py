...
class ProductProductAdapter(GenericAdapter):
    ...
    def search(self, filters=None, from_date=None, to_date=None):
        ...
        if from_date is not None:
            ...
            filters['searchCriteria[filter_groups][0][filters][0][value]'] = '2019-11-26 00:00:00' #from_date.strftime(dt_fmt)
        if to_date is not None:
            ...
            filters['searchCriteria[filter_groups][1][filters][0][value]'] = '2019-11-28 00:00:00' #to_date.strftime(dt_fmt)
