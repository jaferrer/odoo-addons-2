...
class magentoextendImporterV2(Importer):
    ...
    def __init__(self, connector_env):
        ...
        """
        super(magentoextendImporterV2, self).__init__(connector_env)
    ...
    def _import_dependency(self, magentoextend_id, binding_model,
        ...
        if importer_class is None:
            importer_class = magentoextendImporterV2
...
magentoextendImportSynchronizerV2 = magentoextendImporterV2


class BatchImporterV2(Importer):
...
BatchImportSynchronizerV2 = BatchImporterV2


class DirectBatchImporterV2(BatchImporterV2):
...
DirectBatchImportV2 = DirectBatchImporterV2


class DelayedBatchImporterV2(BatchImporterV2):
