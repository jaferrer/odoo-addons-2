...
class TestStockProcurementJIT(common.TransactionCase):
    ...
    def test_01_unlink_moves_of_partially_done_chain(self):
        ...
        move_to_a.picking_id.do_prepare_partial()
        self.assertEqual(len(move_to_a.picking_id.pack_operation_ids), 1)
        self.assertEqual(move_to_a.picking_id.pack_operation_ids.product_id, self.test_product)
        self.assertEqual(move_to_a.picking_id.pack_operation_ids.product_qty, 6)
        move_to_a.picking_id.pack_operation_ids.product_qty = 2
        move_to_a.picking_id.do_transfer()
    ...
    def test_15_procurement_jit_duration_no_end_contract(self):
        ...
        self.assertEqual(procs[5].state, 'running')
