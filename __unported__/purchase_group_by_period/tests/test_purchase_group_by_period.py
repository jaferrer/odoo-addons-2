...
class TestPurchaseGroupByPeriod(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.period_fortnight = self.browse_ref("purchase_group_by_period.fortnight")
        self.period_month = self.browse_ref("purchase_group_by_period.month")
        self.period_year = self.browse_ref("purchase_group_by_period.year")
    ...
    def test_10_all_by_fortnight(self):
        ...
        self.assertEqual(order3_id.date_order_max[0:10], "2015-03-22")
    ...
    def test_40_group_by_years(self):
        ...
        self.assertEqual(order1_id.date_order_max[0:10], "2016-12-31")
