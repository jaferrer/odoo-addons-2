odoo.define('web_ui_stock_batch.BatchMoveLineRow', function (require) {
    ...
    return Widget.extend({
        ...
        update_location: function (location) {
            StockMoveLine.call('change_location_from_scan_batch', [[this.id], location.id])
                .then(() => {
        ...
        send_qty_done_to_odoo: function () {
            StockMoveLine.call('web_ui_update_odoo_qty_batch', [[this.move_line.id], this.quantity_done]);
        },
    });
});
