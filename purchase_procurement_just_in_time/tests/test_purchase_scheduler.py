...
class TestPurchaseScheduler(common.TransactionCase):
    ...
    def test_20_schedule_with_existing_po(self):
        ...
        purchase5.button_confirm()
        self.assertEqual(purchase5.state, 'purchase')
        ...
        # We must detach move5 from picking before action_done (we must transfer picking at once)
        picking = move5.picking_id
        self.assertTrue(picking)
        move5.picking_id = False
    ...
    def test_24_reschedule_after_proc_removal(self):
        ...
        self.assertFalse(self.proc1.purchase_line_id)
        self.assertFalse(self.proc2.purchase_line_id)
        self.assertFalse(self.proc4.purchase_line_id)
