...
class TestPurchaseProcurementJIT(common.TransactionCase):
    ...
    def test_25_purchase_procurement_jit(self):
        ...
        # We must detach moves from picking before action_done (we must transfer picking at once)
        picking = m2.picking_id
        self.assertTrue(picking)
        self.assertEqual(picking, m2.picking_id)
        m2.picking_id = False
        m3.picking_id = False
    ...
    def test_56_purchase_procurement_jit(self):
        ...
        purchase_order_1.button_cancel()
    ...
    def test_57_purchase_procurement_jit(self):
        ...
        self.assertRaises(UserError, test_decreasing_line_qty, line, 0, 1, [])
    ...
    def test_61_purchase_procurement_jit(self):
        ...
        self.assertEqual(proc4.date_planned[:10], "3003-05-05")
    ...
    def test_90_reset_exception_to_confirmed(self):
        ...
        self.assertEqual(picking.pack_operation_ids.product_qty, 48)
        picking.pack_operation_ids.product_qty = 20
        picking.do_transfer()
