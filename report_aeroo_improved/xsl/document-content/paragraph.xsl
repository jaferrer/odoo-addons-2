    ...
    <text:p>
        ...
        <xsl:attribute name="text:style-name">
            <xsl:choose>
                ...
                <xsl:when test="contains(@align,'left')">left</xsl:when>
                <xsl:when test="contains(@align,'center')">center</xsl:when>
                <xsl:when test="contains(@align,'right')">right</xsl:when>
                <xsl:when test="contains(@align,'justify')">justify</xsl:when>
