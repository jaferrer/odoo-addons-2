...
class TestTemplateTasksPlanningImproved(common.TransactionCase):
    ...
    #     self.assertEqual(self.parent_task_3.allocated_duration_unit_tasks, 17)
    #     self.assertEqual(self.parent_task_3.total_allocated_duration, 19)
    ...
    #     self.assertEqual(self.project_task_6.expected_end_date_display, '2017-09-12 18:00:00')
    #     self.assertEqual(self.project_task_7.expected_start_date_display, '2017-09-13 08:00:00')
    #     self.assertEqual(self.project_task_7.expected_end_date_display, '2017-09-13 18:00:00')
    #     self.assertEqual(self.parent_task_2.expected_end_date_display, '2017-09-15 18:00:00')
    ...
    def test_40_reschedule_task_out_of_its_parent(self):
        ...
        self.assertEqual(self.project_task_3.expected_start_date_display, '2017-09-06 08:00:00')
        self.assertEqual(self.project_task_3.expected_end_date_display, '2017-09-07 18:00:00')
        self.assertEqual(self.project_task_1.expected_start_date_display, '2017-09-05 08:00:00')
        self.assertEqual(self.project_task_1.expected_end_date_display, '2017-09-05 18:00:00')
        self.assertEqual(self.project_task_2.expected_start_date_display, '2017-09-06 08:00:00')
        self.assertEqual(self.project_task_2.expected_end_date_display, '2017-09-08 18:00:00')
        self.assertEqual(self.project_task_4.expected_start_date_display, '2017-09-11 08:00:00')
        self.assertEqual(self.project_task_4.expected_end_date_display, '2017-09-15 18:00:00')
        self.assertEqual(self.project_task_5.expected_start_date_display, '2017-09-07 08:00:00')
        self.assertEqual(self.project_task_5.expected_end_date_display, '2017-09-15 18:00:00')
        self.assertEqual(self.project_task_6.expected_start_date_display, '2017-09-06 08:00:00')
        self.assertEqual(self.project_task_6.expected_end_date_display, '2017-09-15 18:00:00')
        self.assertEqual(self.project_task_7.expected_start_date_display, '2017-09-18 08:00:00')
        self.assertEqual(self.project_task_7.expected_end_date_display, '2017-09-18 18:00:00')
        self.assertEqual(self.project_task_8.expected_start_date_display, '2017-09-19 08:00:00')
        self.assertEqual(self.project_task_8.expected_end_date_display, '2017-09-22 18:00:00')
        self.assertEqual(self.project_task_9.expected_start_date_display, '2017-09-19 08:00:00')
        self.assertEqual(self.project_task_9.expected_end_date_display, '2017-10-05 18:00:00')
        self.assertEqual(self.project_task_10.expected_start_date_display, '2017-10-06 08:00:00')
        self.assertEqual(self.project_task_10.expected_end_date_display, '2017-10-13 18:00:00')
        self.assertEqual(self.project_task_11.expected_start_date_display, '2017-10-06 08:00:00')
        self.assertEqual(self.project_task_11.expected_end_date_display, '2017-10-16 18:00:00')
        self.assertEqual(self.parent_task_1.expected_start_date_display, '2017-09-05 08:00:00')
        self.assertEqual(self.parent_task_1.expected_end_date_display, '2017-09-05 18:00:00')
        self.assertEqual(self.parent_task_2.expected_start_date_display, '2017-09-06 08:00:00')
        self.assertEqual(self.parent_task_2.expected_end_date_display, '2017-09-18 18:00:00')
        self.assertEqual(self.parent_task_3.expected_start_date_display, '2017-09-19 08:00:00')
        self.assertEqual(self.parent_task_3.expected_end_date_display, '2017-10-05 18:00:00')
        self.assertEqual(self.parent_task_4.expected_start_date_display, '2017-10-06 08:00:00')
        self.assertEqual(self.parent_task_4.expected_end_date_display, '2017-10-16 18:00:00')
    ...
    #     self.assertEqual(self.parent_task_1.objective_start_date, '2017-08-28 08:00:00')
    #     self.assertEqual(self.parent_task_1.objective_end_date, '2017-08-28 18:00:00')
    #     self.assertEqual(self.parent_task_2.objective_start_date, '2017-08-29 08:00:00')
    ...
    #     self.assertEqual(self.parent_task_3.objective_end_date, '2017-09-26 18:00:00')
    #     self.assertEqual(self.parent_task_4.objective_start_date, '2017-09-27 08:00:00')
    #     self.assertEqual(self.parent_task_4.objective_end_date, '2017-10-05 18:00:00')
    #     for task in self.test_project.task_ids:
    #         self.assertEqual(task.objective_start_date, task.expected_start_date)
    #         self.assertEqual(task.objective_end_date, task.expected_end_date)
    ...
    #     self.env.invalidate_all()
    #     self.assertEqual(self.project_task_7.expected_start_date_display, '2017-09-06 08:00:00')
    #     self.assertEqual(self.project_task_6.expected_end_date_display, '2017-09-05 18:00:00')
    #     self.assertEqual(self.project_task_6.expected_start_date_display, '2017-08-31 08:00:00')
    #     self.assertFalse(self.project_task_7.taken_into_account)
    ...
    #     self.env.invalidate_all()
    #     self.assertEqual(self.project_task_7.expected_start_date_display, '2017-08-31 08:00:00')
    #     self.assertEqual(self.project_task_7.expected_end_date_display, '2017-09-07 18:00:00')
    #     self.assertEqual(self.project_task_6.expected_start_date_display, '2017-08-25 08:00:00')
    #     self.assertEqual(self.project_task_6.expected_end_date_display, '2017-08-30 18:00:00')
    #     self.assertEqual(self.project_task_4.expected_start_date_display, '2017-09-01 08:00:00')
    #     self.assertEqual(self.project_task_4.expected_end_date_display, '2017-09-07 18:00:00')
    #     self.assertEqual(self.project_task_2.expected_start_date_display, '2017-08-29 08:00:00')
    #     self.assertEqual(self.project_task_2.expected_end_date_display, '2017-08-31 18:00:00')
    #     self.assertEqual(self.project_task_3.expected_start_date_display, '2017-08-29 08:00:00')
    #     self.assertEqual(self.project_task_3.expected_end_date_display, '2017-08-30 18:00:00')
    #     self.assertEqual(self.project_task_5.expected_start_date_display, '2017-08-30 08:00:00')
    #     self.assertEqual(self.project_task_5.expected_end_date_display, '2017-09-07 18:00:00')
    #     self.assertEqual(self.project_task_8.expected_start_date_display, '2017-09-08 08:00:00')
    #     self.assertEqual(self.project_task_8.expected_end_date_display, '2017-09-13 18:00:00')
    #     self.assertEqual(self.project_task_9.expected_start_date_display, '2017-09-08 08:00:00')
    #     self.assertEqual(self.project_task_9.expected_end_date_display, '2017-09-26 18:00:00')
    #     self.assertEqual(self.project_task_10.expected_start_date_display, '2017-09-27 08:00:00')
    #     self.assertEqual(self.project_task_10.expected_end_date_display, '2017-10-04 18:00:00')
    #     self.assertEqual(self.project_task_11.expected_start_date_display, '2017-09-27 08:00:00')
    #     self.assertEqual(self.project_task_11.expected_end_date_display, '2017-10-05 18:00:00')
    #     self.assertEqual(self.project_task_1.expected_start_date_display, '2017-08-24 08:00:00')
    #     self.assertEqual(self.project_task_1.expected_end_date_display, '2017-08-24 18:00:00')
    #
    #     self.assertEqual(self.parent_task_1.expected_start_date_display, '2017-08-22 08:00:00')
    #     self.assertEqual(self.parent_task_1.expected_end_date_display, '2017-08-24 18:00:00')
    #     self.assertEqual(self.parent_task_2.expected_start_date_display, '2017-08-25 08:00:00')
    #     self.assertEqual(self.parent_task_2.expected_end_date_display, '2017-09-07 18:00:00')
    #     self.assertEqual(self.parent_task_3.expected_start_date_display, '2017-09-08 08:00:00')
    #     self.assertEqual(self.parent_task_3.expected_end_date_display, '2017-09-26 18:00:00')
    #     self.assertEqual(self.parent_task_4.expected_start_date_display, '2017-09-27 08:00:00')
    #     self.assertEqual(self.parent_task_4.expected_end_date_display, '2017-10-05 18:00:00')
    #
    ...
    #     self.env.invalidate_all()
    #     self.assertEqual(self.parent_task_1.expected_start_date_display, '2017-08-16 08:00:00')
    #     self.assertEqual(self.parent_task_1.expected_end_date_display, '2017-09-05 18:00:00')
    #     self.assertEqual(self.project_task_1.expected_start_date_display, '2017-09-05 08:00:00')
    #     self.assertEqual(self.project_task_1.expected_end_date_display, '2017-09-05 18:00:00')
    ...
    #         self.parent_task_4.expected_end_date_display = '2017-07-11 14:00:00'
    #
    ...
    #     with self.assertRaises(UserError):
    #         self.project_task_11.expected_end_date_display = '2017-10-20 18:00:00'
    #
    ...
    #     self.parent_task_3.expected_start_date = '2017-09-11 08:00:00'
    #     self.assertEqual(self.parent_task_3.expected_start_date_display, '2017-09-11 08:00:00')
    #     self.assertEqual(self.parent_task_3.expected_end_date_display, '2017-10-04 18:00:00')
    #
    #     # Tasks 8, 9, 10, 11 and parent task 3 should not have been rescheduled
    #     self.assertEqual(self.project_task_8.expected_start_date_display, '2017-09-18 08:00:00')
    #     self.assertEqual(self.project_task_8.expected_end_date_display, '2017-09-21 18:00:00')
    #     self.assertEqual(self.project_task_9.expected_start_date_display, '2017-09-18 08:00:00')
    #     self.assertEqual(self.project_task_9.expected_end_date_display, '2017-10-04 18:00:00')
    #     self.assertEqual(self.project_task_10.expected_start_date_display, '2017-10-05 08:00:00')
    #     self.assertEqual(self.project_task_10.expected_end_date_display, '2017-10-12 18:00:00')
    #     self.assertEqual(self.project_task_11.expected_start_date_display, '2017-10-05 08:00:00')
    #     self.assertEqual(self.project_task_11.expected_end_date_display, '2017-10-13 18:00:00')
    #     self.assertEqual(self.parent_task_4.expected_start_date_display, '2017-10-05 08:00:00')
    #     self.assertEqual(self.parent_task_4.expected_end_date_display, '2017-10-13 18:00:00')
    #
    #     # Other tasks should have been rescheduled
    #     self.assertEqual(self.project_task_4.expected_start_date_display, '2017-09-04 08:00:00')
    #     self.assertEqual(self.project_task_4.expected_end_date_display, '2017-09-08 18:00:00')
    #     self.assertEqual(self.project_task_5.expected_start_date_display, '2017-08-31 08:00:00')
    #     self.assertEqual(self.project_task_5.expected_end_date_display, '2017-09-08 18:00:00')
    #     self.assertEqual(self.project_task_7.expected_start_date_display, '2017-09-08 08:00:00')
    #     self.assertEqual(self.project_task_7.expected_end_date_display, '2017-09-08 18:00:00')
    #     self.assertEqual(self.project_task_6.expected_start_date_display, '2017-09-04 08:00:00')
    #     self.assertEqual(self.project_task_6.expected_end_date_display, '2017-09-07 18:00:00')
    #     self.assertEqual(self.project_task_3.expected_start_date_display, '2017-09-06 08:00:00')
    #     self.assertEqual(self.project_task_3.expected_end_date_display, '2017-09-07 18:00:00')
    #     self.assertEqual(self.project_task_2.expected_start_date_display, '2017-08-30 08:00:00')
    #     self.assertEqual(self.project_task_2.expected_end_date_display, '2017-09-01 18:00:00')
    #     self.assertEqual(self.project_task_1.expected_start_date_display, '2017-08-29 08:00:00')
    #     self.assertEqual(self.project_task_1.expected_end_date_display, '2017-08-29 18:00:00')
    #     self.assertEqual(self.parent_task_1.expected_start_date_display, '2017-08-29 08:00:00')
    #     self.assertEqual(self.parent_task_1.expected_end_date_display, '2017-08-29 18:00:00')
    #     self.assertEqual(self.parent_task_2.expected_start_date_display, '2017-08-30 08:00:00')
    #     self.assertEqual(self.parent_task_2.expected_end_date_display, '2017-09-08 18:00:00')
    #
    ...
    #     self.env.invalidate_all()
    #     self.assertEqual(self.project_task_3.expected_start_date_display, '2017-09-04 08:00:00')
    #
    ...
    #     self.project_task_10.expected_end_date_display = '2017-09-15 22:00:00'
    #     self.env.invalidate_all()
    #     self.assertEqual(self.project_task_10.expected_end_date_display, '2017-09-15 18:00:00')
    #
    #     # We try to set a end date during a weekend
    #     with self.assertRaises(ValidationError):
    #         self.project_task_10.expected_end_date_display = '2017-09-16 02:00:00'
    #
    ...
    #     self.test_project.task_ids.write({'taken_into_account': False})
    #     self.assertEqual(self.parent_task_3.expected_start_date_display, '2017-09-18 08:00:00')
    #     self.assertEqual(self.parent_task_3.expected_end_date_display, '2017-10-04 18:00:00')
    ...
    #     })
    #
    #     self.assertEqual(self.parent_task_3.expected_start_date_display, '2017-09-27 08:00:00')
    #     self.assertEqual(self.parent_task_3.expected_end_date_display, '2017-10-13 18:00:00')
    #
    #     self.assertEqual(self.parent_task_4.expected_start_date_display, '2017-10-16 08:00:00')
    #     self.assertEqual(self.parent_task_4.expected_end_date_display, '2017-10-24 18:00:00')
    #
    ...
    #     self.assertEqual(self.project_task_5.expected_end_date_display, '2017-09-15 18:00:00')
    #     self.assertEqual(self.project_task_6.expected_start_date_display, '2017-09-06 08:00:00')
    #     self.assertEqual(self.project_task_6.expected_end_date_display, '2017-09-11 18:00:00')
    #     self.assertEqual(self.project_task_7.expected_start_date_display, '2017-09-12 08:00:00')
    #     self.assertEqual(self.project_task_7.expected_end_date_display, '2017-09-12 18:00:00')
    #     self.assertEqual(self.parent_task_1.expected_start_date_display, '2017-09-05 08:00:00')
    #     self.assertEqual(self.parent_task_1.expected_end_date_display, '2017-09-05 18:00:00')
    #     self.assertEqual(self.parent_task_2.expected_start_date_display, '2017-09-06 08:00:00')
    #     self.assertEqual(self.parent_task_2.expected_end_date_display, '2017-09-15 18:00:00')
    ...
    #     self.assertEqual(self.project_task_8.expected_start_date_display, '2017-09-27 08:00:00')
    #     self.assertEqual(self.project_task_8.expected_end_date_display, '2017-10-02 18:00:00')
    #     self.assertEqual(self.project_task_9.expected_start_date_display, '2017-09-27 08:00:00')
    #     self.assertEqual(self.project_task_9.expected_end_date_display, '2017-10-13 18:00:00')
    #     self.assertEqual(self.project_task_10.expected_start_date_display, '2017-10-16 08:00:00')
    #     self.assertEqual(self.project_task_10.expected_end_date_display, '2017-10-23 18:00:00')
    #     self.assertEqual(self.project_task_11.expected_start_date_display, '2017-10-16 08:00:00')
    #     self.assertEqual(self.project_task_11.expected_end_date_display, '2017-10-24 18:00:00')
    #
    # def test_92_reschedule_and_raise_because_tia(self):
    #     self.schedule_from_task_3()
    #     self.assertTrue(self.project_task_3.taken_into_account)
    #     with self.assertRaises(UserError):
    #         self.project_task_1.expected_end_date_display = '2017-09-06 18:00:00'
    #
    ...
    #     })
    #     self.assertEqual(self.project_task_7.expected_start_date_display, '2017-08-31 08:00:00')
    #     self.assertEqual(self.project_task_7.expected_end_date_display, '2017-09-01 18:00:00')
    #
    ...
    #     self.assertEqual(self.project_task_2_1.expected_start_date_display, '2019-07-15 08:00:00')
    #     self.assertEqual(self.project_task_2_1.expected_end_date_display, '2019-07-15 18:00:00')
    #     self.assertEqual(self.project_task_2_2.expected_start_date_display, '2019-07-16 08:00:00')
    #     self.assertEqual(self.project_task_2_2.expected_end_date_display, '2019-07-19 18:00:00')
    #     self.assertEqual(self.project_task_2_3.expected_start_date_display, '2019-07-16 08:00:00')
    #     self.assertEqual(self.project_task_2_3.expected_end_date_display, '2019-07-16 18:00:00')
    #     self.assertEqual(self.project_task_2_4.expected_start_date_display, '2019-07-17 08:00:00')
    #     self.assertEqual(self.project_task_2_4.expected_end_date_display, '2019-07-17 18:00:00')
    #     self.assertEqual(self.project_task_2_5.expected_start_date_display, '2019-07-18 08:00:00')
    #     self.assertEqual(self.project_task_2_5.expected_end_date_display, '2019-07-18 18:00:00')
    #     self.assertEqual(self.project_task_2_6.expected_start_date_display, '2019-07-19 08:00:00')
    #     self.assertEqual(self.project_task_2_6.expected_end_date_display, '2019-07-19 18:00:00')
    #     self.assertEqual(self.project_task_2_7.expected_start_date_display, '2019-07-22 08:00:00')
    #     self.assertEqual(self.project_task_2_7.expected_end_date_display, '2019-07-22 18:00:00')


# TODO: tester les jallons, en mode critique et non critique, en début et en fin de journée
# TODO: tester la transformation d'un jallon en vraie tâche