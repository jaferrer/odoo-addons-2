...
class TestTemplateTasksPlanningImproved(common.TransactionCase):
    ...
    def test_30_auto_planning_task_no_next_task(self):
        ...
        self.assertEqual(self.project_task_9.objective_start_date, '2017-09-05 08:00:00')
        self.assertEqual(self.project_task_9.objective_end_date, '2017-09-21 18:00:00')
        self.assertEqual(self.project_task_10.objective_start_date, '2017-09-22 08:00:00')
        self.assertEqual(self.project_task_10.objective_end_date, '2017-09-29 18:00:00')
        self.assertEqual(self.project_task_11.objective_start_date, '2017-09-22 08:00:00')
        self.assertEqual(self.project_task_11.objective_end_date, '2017-10-02 18:00:00')
    ...
    def test_40_auto_planning_task_no_previous_task(self):
        ...
        self.assertEqual(self.project_task_9.objective_start_date, '2017-08-28 08:00:00')
        self.assertEqual(self.project_task_9.objective_end_date, '2017-09-13 18:00:00')
        self.assertEqual(self.project_task_10.objective_start_date, '2017-09-14 08:00:00')
        self.assertEqual(self.project_task_10.objective_end_date, '2017-09-21 18:00:00')
        self.assertEqual(self.project_task_11.objective_start_date, '2017-09-14 08:00:00')
        self.assertEqual(self.project_task_11.objective_end_date, '2017-09-22 18:00:00')
    ...
    def test_60_reschedule_next_and_previous_tasks(self):
        ...
        self.parent_task_3.expected_end_date = '2017-09-25 14:00:00'
        self.env.invalidate_all()
        ...
        self.assertEqual(self.project_task_11.expected_end_date, '2017-09-18 18:00:00')
        with self.assertRaises(UserError):
    ...
    def test_70_reschedule_children_tasks(self):
        ...
        self.assertEqual(self.project_task_9.expected_start_date, '2017-08-22 08:00:00')
        self.assertEqual(self.project_task_9.expected_end_date, '2017-09-07 18:00:00')
        self.assertFalse(self.parent_task_1.taken_into_account)
        self.assertEqual(self.project_task_1.expected_start_date, '2017-08-22 08:00:00')
        self.assertEqual(self.project_task_1.expected_end_date, '2017-08-22 18:00:00')
        ...
        self.assertEqual(self.project_task_10.expected_start_date, '2017-09-19 08:00:00')
        self.assertEqual(self.project_task_10.expected_end_date, '2017-09-26 18:00:00')
        self.assertFalse(self.project_task_11.taken_into_account)
        self.assertEqual(self.project_task_11.expected_start_date, '2017-09-19 08:00:00')
        self.assertEqual(self.project_task_11.expected_end_date, '2017-09-27 18:00:00')
        self.assertFalse(self.parent_task_3.taken_into_account)
        self.assertEqual(self.parent_task_3.expected_start_date, '2017-09-19 08:00:00')
        self.assertEqual(self.parent_task_3.expected_end_date, '2017-09-27 18:00:00')
        with self.assertRaises(UserError):
        ...
        self.env.invalidate_all()
        self.assertEqual(self.parent_task_1.expected_start_date, '2017-08-21 08:00:00')
        ...
        self.assertEqual(self.project_task_5.expected_start_date, '2017-08-24 08:00:00')
        self.assertEqual(self.project_task_5.expected_end_date, '2017-09-01 18:00:00')
        self.assertEqual(self.project_task_6.expected_start_date, '2017-08-28 08:00:00')
        self.assertEqual(self.project_task_6.expected_end_date, '2017-08-31 18:00:00')
        self.assertEqual(self.project_task_7.expected_start_date, '2017-09-01 08:00:00')
        self.assertEqual(self.project_task_7.expected_end_date, '2017-09-01 18:00:00')
        self.assertEqual(self.project_task_2.expected_start_date, '2017-08-23 08:00:00')
        self.assertEqual(self.project_task_2.expected_end_date, '2017-08-25 18:00:00')
        self.assertEqual(self.project_task_3.expected_start_date, '2017-08-23 08:00:00')
        self.assertEqual(self.project_task_3.expected_end_date, '2017-08-24 18:00:00')
        # Task 1 and parent task 0 should have been rescheduled
        self.assertFalse(self.project_task_1.taken_into_account)
        self.assertEqual(self.project_task_1.expected_start_date, '2017-08-18 08:00:00')
        self.assertEqual(self.project_task_1.expected_end_date, '2017-08-18 18:00:00')
        self.assertFalse(self.parent_task_0.taken_into_account)
        self.assertEqual(self.parent_task_0.expected_start_date, '2017-08-18 08:00:00')
        self.assertEqual(self.parent_task_0.expected_end_date, '2017-08-18 18:00:00')
    ...
    def test_80_reschedule_task_not_working_hour(self):
        ...
        self.project_task_8.expected_start_date = '2017-09-04 02:00:00'
        self.env.invalidate_all()
        self.assertEqual(self.project_task_8.expected_start_date, '2017-09-04 08:00:00')

        # We try to set a start date during a weekend
        self.project_task_8.expected_start_date = '2017-09-03 15:00:00'
        self.env.invalidate_all()
        self.assertEqual(self.project_task_8.expected_start_date, '2017-09-04 08:00:00')
