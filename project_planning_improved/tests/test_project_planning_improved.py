...
class TestTemplateTasksPlanningImproved(common.TransactionCase):
    ...
    def test_17_hide_tasks_in_timeline_and_reschedule(self):
        ...
        self.assertEqual(self.project_task_7.expected_start_date, '2017-09-06')
        self.assertEqual(self.project_task_7.expected_end_date, '2017-09-06')
        self.assertEqual(self.project_task_8.expected_start_date, '2017-09-12')
        self.assertEqual(self.project_task_8.expected_end_date, '2017-09-15')
        self.assertEqual(self.project_task_9.expected_start_date, '2017-09-12')
        self.assertEqual(self.project_task_9.expected_end_date, '2017-09-28')
        self.assertEqual(self.project_task_10.expected_start_date, '2017-09-29')
        self.assertEqual(self.project_task_10.expected_end_date, '2017-10-06')
        self.assertEqual(self.project_task_11.expected_start_date, '2017-09-29')
        self.assertEqual(self.project_task_11.expected_end_date, '2017-10-09')
        self.assertEqual(self.parent_task_1.expected_start_date, '2017-09-05')
        self.assertEqual(self.parent_task_1.expected_end_date, '2017-09-05')
        self.assertEqual(self.parent_task_2.expected_start_date, '2017-09-06')
        self.assertEqual(self.parent_task_2.expected_end_date, '2017-09-11')
        self.assertEqual(self.parent_task_3.expected_start_date, '2017-09-12')
        self.assertEqual(self.parent_task_3.expected_end_date, '2017-09-28')
        self.assertEqual(self.parent_task_4.expected_start_date, '2017-09-29')
        self.assertEqual(self.parent_task_4.expected_end_date, '2017-10-09')
