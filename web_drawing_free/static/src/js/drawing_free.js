...
var QWeb = instance.web.qweb;
	...
	instance.web.form.FieldSketch = instance.web.form.FieldBinary.extend({
	    ...
	    on_valid_sketch:function() {
	    	...
	    	//var data='{"session_id":"'+self.session.override_session+'","callback":"'+self.fileupload_id+'","ufile" : "' + document.getElementById("simple_sketch").toDataURL("image/png") + '" }';
	    	$.ajax({
	            type: 'POST',
	...
	instance.web.form.widgets.add('sketch', 'instance.web.form.FieldSketch');
