...
.nvd3 line.nv-guideline {
  stroke: #ccc;
        ...
        contenthtml = """<html><head><head><body style="width:100%;height:100%;">""" + \
            ...
            """<h4>Filtres : </h4>""" + str(options["filter"]) + \
            """<h4>Colonnes : </h4>""" + str(options["col"]) + \
            """<h4>Lignes : </h4>""" + str(options["row"]) + \
            """</div>""" + \
            data + \
        ...
        content = request.env["report"]._run_wkhtmltopdf(
            [], [], [(0, node)], True, paperformat, spec_paperformat_args=spec_paperformat_args, save_in_attachment={})
