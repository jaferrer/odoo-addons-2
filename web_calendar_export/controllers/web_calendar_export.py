...
class WebCalendarExporter(http.Controller):
    ...
    def export_calendar(self, data, token):
        ...
        # css is a local copy of odoo/addons/web_calendar/static/lib/fullcalendar/css/fullcalendar.css
        css = u"""
.fc {
	direction: ltr;
	text-align: left;
...
@media print {
	...
	.fc-event .ui-resizable-handle {
        ...
        node = mini_template.render(dict(css=css, subst=True, body=contenthtml, base_url=base_url))
