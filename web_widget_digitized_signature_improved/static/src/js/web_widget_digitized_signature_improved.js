odoo.define('web_widget_digitized_signature_improved', function(require) {
    "use strict";
    ...
    var FieldSignature = BasicFields.FieldBinaryImage.extend({
        ...
        init: function() {
            ...
            let width = this.nodeOptions && this.nodeOptions.width || _width;
            let height = this.nodeOptions && this.nodeOptions.height || _height;
            let decor_color = this.nodeOptions && this.nodeOptions.decor_color || _decor_color;

            this.sign_options = {
                'decor-color': decor_color,
                'color': '#000',
