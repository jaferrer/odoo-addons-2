...
class AccountMoveExportWizard(models.TransientModel):
    ...
    line_selection = fields.Selection([
        ...
        ('not_exported', u"Lines not previously exported"), ], u"Line selection", required=True, default='not_exported')
    ...
    def action_validate(self):
        ...
        self.binary_export = base64.encodebytes(self._create_export_from_moves(moves))
    ...
    def _send_to_ftp(self):
        ...
        dest_ftp.storbinary(u"STOR %s" % self.data_fname, BytesIO(base64.decodebytes(self.binary_export)))
