...
class AccountConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            export_group_by_account=safe_eval(
                self.env['ir.config_parameter'].sudo().get_param('account_move_export.export_group_by_account',
                                                                 'False')),
    ...
    def set_values(self):
        ...
        param.set_param('account_move_export.export_line_selection', self.export_line_selection)
        param.set_param('account_move_export.export_journal_ids', str(self.export_journal_ids.ids))
        param.set_param('account_move_export.export_date_from', self.export_date_from)
        param.set_param('account_move_export.export_date_to', self.export_date_to)
        param.set_param('account_move_export.export_group_by_account', str(self.export_group_by_account))
        param.set_param('account_move_export.export_ftp_url', self.export_ftp_url)
        param.set_param('account_move_export.export_ftp_port', self.export_ftp_port)
        param.set_param('account_move_export.export_ftp_login', self.export_ftp_login)
        param.set_param('account_move_export.export_ftp_password', self.export_ftp_password)
        param.set_param('account_move_export.export_ftp_path', self.export_ftp_path)
